...
export const INITIAL_USERS: User[] = [
  ...
  },
  {
    ...
    trustLevel: 2,
    trustTitle: '进阶佬友',
    bio: '研究 Claude 3.7 / DeepSeek-R1 最佳提示词模式。',
    joinedAt: '2024-06-12',
    likesReceived: 670,
    topicsCount: 12,
  },
  {
    id: 'user-current',
    username: 'OrionExplorer',
    name: '星际探索者',
    avatar: 'https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?w=150&auto=format&fit=crop&q=80',
    trustLevel: 2,
    trustTitle: '进阶佬友',
    bio: '这是你的当前账号，随时可以发帖、回复或切换身份！',
    joinedAt: '2024-07-20',
    likesReceived: 215,
    topicsCount: 5,
  },
...
export const INITIAL_TOPICS: Topic[] = [
  {
    ...
    aiSummary:
      '本帖为 Orion 社区创始公告，详细阐释了 Orion 的核心理念：真诚交流、拒绝低质灌水、鼓励开源分享。同时公布了 Lv.0 到 Lv.4 的信任等级（Trust Level）晋升路径以及专属徽章特权体系。',
...
大家目前手里主力都在用哪家？欢迎在评论区贴测速图交流！`,
    replies: [
      ...
      },
      {
        ...
        likes: 8,
        isLiked: false,
        content: `@星际探索者 9929 走德国法兰克福机房晚高峰也能保持在 150ms 左右，非常适合挂邮件服务或者私有容器仓库。`,
      },
    ],
  },
  {
